...
public final class OperationDefaults {
    ...
    /**
     * Returns an instance initialised with {@link Operation#CLEAN_INSERT}, {@link Operation#NONE}
     * and the default floating-point epsilon.
     *
    ...
    public String toString() {
        return "OperationDefaults[preparation=" + preparation
                + ", expectation=" + expectation
                + ", floatingPointEpsilon=" + floatingPointEpsilon + ']';
    }
